...
# download URLs
export PANEL_DL_URL="https://github.com/PowerHutPanel/panel-dev/releases/latest/download/panel.tar.gz"
...
export GITHUB_BASE_URL=${GITHUB_BASE_URL:-"https://github.com/PowerHutPanel/installer"}
